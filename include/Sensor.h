 ...
 *
 * This header previously accumulated duplicated `#ifndef` guards during merges,
 * which breaks compilation on Linux (case-sensitive + strict preprocessing).
 * Use `#pragma once` and keep a single, canonical declaration set.
 */
